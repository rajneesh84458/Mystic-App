...
import TimeLinerFour from './TimeLinerFour';
...
<View style={{width:270,height:200,borderColor:'transparent',borderWidth:1,marginVertical:5}}>
  ...
  <View style={{ flexDirection:'row',width:'100%',justifyContent:"space-between",height:20,borderColor:'transparent',borderWidth:1,marginBottom:20}}>
              ...
              <Picker.Item label="Shirt Size" value="key0" />
...
<View style={{ flexDirection:'row',width:'100%',justifyContent:"space-between",height:20,borderColor:'transparent',borderWidth:1}}>
              ...
              <Picker.Item label="Interest/Hobbies" value="key0" />
              <Picker.Item label="ATM Card" value="key1" />
              <Picker.Item label="Debit Card" value="key2" />
              <Picker.Item label="Credit Card" value="key3" />
              <Picker.Item label="Net Banking" value="key4" />
    ...
    <LinearGradient
      ...
      <AntDesign name="arrowright" size={25} color="white"  onPress={() => navigate("SignUp5")}/>
      </LinearGradient>
      </View>
